...
// photo = Wikimedia Commons (vrij te gebruiken mits bronvermelding); credit
// wordt onder de foto getoond. Binnenfoto waar beschikbaar, anders buitenkant.
const W = 'https://upload.wikimedia.org/wikipedia/commons/thumb'
const STADIONS = [
  { match: ['sofi stadium'], city: 'Los Angeles', capacity: 70240, tz: 'America/Los_Angeles', lat: 33.9535, lng: -118.3392,
    photo: `${W}/b/b0/SoFi_Stadium_interior_2021.jpg/1280px-SoFi_Stadium_interior_2021.jpg`, photoCredit: 'Troutfarm27 · Wikimedia Commons (CC BY-SA 4.0)' },
  { match: ['metlife stadium'], city: 'New York / New Jersey', capacity: 82500, tz: 'America/New_York', lat: 40.8135, lng: -74.0745,
    photo: `${W}/c/ce/Metlife_Stadium%2C_2013_Soccer_International_Champions_Cup_-_panoramio_%281%29.jpg/1280px-Metlife_Stadium%2C_2013_Soccer_International_Champions_Cup_-_panoramio_%281%29.jpg`, photoCredit: 'Alen Ištoković · Wikimedia Commons (CC BY 3.0)' },
  { match: ['at t stadium', 'att stadium', 'dallas stadium', 'arlington'], city: 'Dallas', capacity: 80000, tz: 'America/Chicago', lat: 32.7473, lng: -97.0945,
    photo: `${W}/b/bb/The_Dallas_Cowboys_Cheerleaders_entertain_the_crowd_at_a_National_Football_League_game_at_the_Cowboys%27_home_field_AT%26T_Stadium_in_Arlington%2C_Texas_LCCN2015630564.tif/lossy-page1-1280px-thumbnail.tif.jpg`, photoCredit: 'Carol M. Highsmith · Wikimedia Commons (publiek domein)' },
  { match: ['mercedes benz stadium', 'atlanta stadium'], city: 'Atlanta', capacity: 71000, tz: 'America/New_York', lat: 33.7553, lng: -84.4006,
    photo: `${W}/a/af/2019_Peach_Bowl_LSU_vs_OU_Mercedes-Benz_Stadium_interior.jpg/1280px-2019_Peach_Bowl_LSU_vs_OU_Mercedes-Benz_Stadium_interior.jpg`, photoCredit: 'Spatms · Wikimedia Commons (CC BY-SA 4.0)' },
  { match: ['nrg stadium', 'houston stadium'], city: 'Houston', capacity: 72220, tz: 'America/Chicago', lat: 29.6847, lng: -95.4107,
    photo: `${W}/3/3e/NRG_stadium_prepared_for_Super_Bowl_Li_%2832513086661%29.jpg/1280px-NRG_stadium_prepared_for_Super_Bowl_Li_%2832513086661%29.jpg`, photoCredit: 'U.S. Customs and Border Protection · Wikimedia Commons (publiek domein)' },
  { match: ['arrowhead stadium', 'geha field', 'kansas city stadium'], city: 'Kansas City', capacity: 76416, tz: 'America/Chicago', lat: 39.0489, lng: -94.4839,
    photo: `${W}/0/09/Sailors_Tour_Arrowhead_Stadium_During_Kansas_City_Navy_Week_2021.jpg/1280px-Sailors_Tour_Arrowhead_Stadium_During_Kansas_City_Navy_Week_2021.jpg`, photoCredit: 'U.S. Navy · Wikimedia Commons (publiek domein)' },
  { match: ['hard rock stadium', 'miami stadium'], city: 'Miami', capacity: 65326, tz: 'America/New_York', lat: 25.9580, lng: -80.2389,
    photo: `${W}/9/99/Interior_of_updated_Hard_Rock_Stadium.jpg/1280px-Interior_of_updated_Hard_Rock_Stadium.jpg`, photoCredit: 'Gatorfan252525 · Wikimedia Commons (CC BY-SA 4.0)' },
  { match: ['gillette stadium', 'boston stadium', 'foxborough'], city: 'Boston', capacity: 65878, tz: 'America/New_York', lat: 42.0909, lng: -71.2643,
    photo: `${W}/4/46/Gillette_Stadium_panorama.jpg/1280px-Gillette_Stadium_panorama.jpg`, photoCredit: 'Kenneth C. Zirkel · Wikimedia Commons (CC BY-SA 4.0)' },
  { match: ['lincoln financial field', 'philadelphia stadium'], city: 'Philadelphia', capacity: 69596, tz: 'America/New_York', lat: 39.9008, lng: -75.1675,
    photo: `${W}/f/f4/US_Navy_091212-N-9693M-654_Navy_quarterback_Ricky_Dobbs_%28%5E4%29_scrambles_for_a_gain_during_the_second_quarter_of_the_110th_Army-Navy_college_football_game_at_Lincoln_Financial_Field_in_Philadelphia.jpg/1280px-thumbnail.jpg`, photoCredit: 'U.S. Navy · Wikimedia Commons (publiek domein)' },
  { match: ['levi s stadium', 'levis stadium', 'san francisco bay area stadium', 'bay area'], city: 'San Francisco Bay Area', capacity: 68500, tz: 'America/Los_Angeles', lat: 37.4030, lng: -121.9700,
    photo: `${W}/4/47/Levi%27s_Stadium_Super_Bowl_50_%28endzone_upper_deck_with_temporary_seating%29.jpg/1280px-Levi%27s_Stadium_Super_Bowl_50_%28endzone_upper_deck_with_temporary_seating%29.jpg`, photoCredit: 'Arnie Papp · Wikimedia Commons (CC BY 2.0)' },
  { match: ['lumen field', 'seattle stadium'], city: 'Seattle', capacity: 68740, tz: 'America/Los_Angeles', lat: 47.5952, lng: -122.3316,
    photo: `${W}/3/33/2025_Leagues_Cup_Final_-_south_end_of_Lumen_Field.jpg/1280px-2025_Leagues_Cup_Final_-_south_end_of_Lumen_Field.jpg`, photoCredit: 'Barcaforever69 · Wikimedia Commons (CC0)' },
  { match: ['bmo field', 'toronto stadium'], city: 'Toronto', capacity: 45000, tz: 'America/Toronto', lat: 43.6332, lng: -79.4185,
    photo: `${W}/0/00/BMO_Field_East_Stands.jpg/1280px-BMO_Field_East_Stands.jpg`, photoCredit: 'Leafsfan67 · Wikimedia Commons (CC BY-SA 3.0)' },
  { match: ['bc place', 'vancouver stadium'], city: 'Vancouver', capacity: 54500, tz: 'America/Vancouver', lat: 49.2768, lng: -123.1120,
    photo: `${W}/2/2b/BC_Place_inflated_roof_inside.jpg/1280px-BC_Place_inflated_roof_inside.jpg`, photoCredit: 'Iwona Erskine-Kellie · Wikimedia Commons (CC BY 2.0)' },
  { match: ['estadio azteca', 'estadio banorte', 'mexico city stadium'], city: 'Mexico-Stad', capacity: 87523, tz: 'America/Mexico_City', lat: 19.3029, lng: -99.1505,
    photo: `${W}/2/24/Interior_del_Estadio_Azteca_por_Ludovic_Delot_Bravo.jpg/1280px-Interior_del_Estadio_Azteca_por_Ludovic_Delot_Bravo.jpg`, photoCredit: 'Ludovic Delot · Wikimedia Commons (CC BY-SA 4.0)' },
  { match: ['estadio akron', 'estadio guadalajara', 'guadalajara stadium'], city: 'Guadalajara', capacity: 48071, tz: 'America/Mexico_City', lat: 20.6818, lng: -103.4626,
    photo: `${W}/e/ef/Estadio_Akron_interior_0319.jpg/1280px-Estadio_Akron_interior_0319.jpg`, photoCredit: 'Alejan98 · Wikimedia Commons (CC0)' },
  { match: ['estadio bbva', 'estadio monterrey', 'monterrey stadium'], city: 'Monterrey', capacity: 53500, tz: 'America/Monterrey', lat: 25.6694, lng: -100.2444,
    photo: `${W}/5/57/Mexico_Guadalupe_Monterrey_Estadio_BBVA_Bancomer_fifa_world_cup_2026_6.JPG/1280px-Mexico_Guadalupe_Monterrey_Estadio_BBVA_Bancomer_fifa_world_cup_2026_6.JPG`, photoCredit: 'Arne Müseler · Wikimedia Commons (CC BY-SA 3.0)' },
]
